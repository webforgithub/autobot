...
trait Strategies
{
    protected $strategies_all = [
         'cryptobee_sar_stoch'
        ,'cryptobee_awesome_macd'
        ,'cryptobee_adx_smas'
        ,'cryptobee_rsi_macd'
        ,'cryptobee_sar_rsi'
        ,'cryptobee_stoch_adx'
        ,'cryptobee_cci_scalper'
        ,'cryptobee_ema_scalper'
        ,'cryptobee_ema_stoch_rsi'
        ,'cryptobee_double_volatility'
        ,'cryptobee_adx_momentum'
        ,'cryptobee_base_150'
        ,'cryptobee_breakout_ma'
        ,'cryptobee_sar_awesome'
        ,'cryptobee_cci_ema'
        ,'cryptobee_bband_rsi'
        ,'cryptobee_ema_adx_macd'
        ,'cryptobee_mov_avg_sar'
        ,'cryptobee_momentum'
        ,'cryptobee_sma_stoch_rsi'

        // not organized into time series yet...
        // need to test them more..
        ,'cryptobee_sar_sma'
        ,'cryptobee_ema_adx'
        ,'cryptobee_trend_bounce'
        ,'cryptobee_5th_element'
        ,'cryptobee_powerranger'
        ,'cryptobee_famamama'
    ];
    ...
    protected $strategies_30m = ['cryptobee_sar_awesome'];

    protected $strategies_1h = [
         'cryptobee_ema_stoch_rsi'
        ,'cryptobee_base_150'
        ,'cryptobee_breakout_ma' // technically this is a 1d, but can be used more
        ,'cryptobee_cci_ema'
        ,'cryptobee_ema_adx_macd' // technically a 4h
        ,'cryptobee_mov_avg_sar'
        ,'cryptobee_momentum'
        ,'cryptobee_sma_stoch_rsi'
    ];
     ...
     * @return int
     */
    public function cryptobee_sar_stoch($pair, $data, $return_full=false)
    {
     ...
     * @return int
     */
    public function cryptobee_awesome_macd($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function cryptobee_adx_smas($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function cryptobee_rsi_macd($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function cryptobee_sar_rsi($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function cryptobee_stoch_adx($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     *         opposite direction
     */
    public function cryptobee_cci_scalper($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function cryptobee_ema_scalper($pair, $data, $return_full=false)
    {
     ...
     * @return int
     */
    public function cryptobee_ema_stoch_rsi($pair, $data, $return_full=false)
    {
     ...
     * @return int
     */
    public function cryptobee_double_volatility($pair, $data, $return_full=false)
    {
     ...
     * @return int
     */
    public function cryptobee_adx_momentum($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return array|int
     */
    public function cryptobee_base_150($pair, $data, $return_full=false)
    {
     ...
     * @return int
     */
    public function cryptobee_breakout_ma($pair, $data, $return_full=false)
    {
        $sma20_low  = $this->sma_maker($data['low'], 20);
     ...
     * @return int
     */
    public function cryptobee_sar_awesome($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function cryptobee_cci_ema($pair, $data, $return_full=false)
    {
     ...
     * @return int
     */
    public function cryptobee_bband_rsi($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function cryptobee_ema_adx_macd($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function cryptobee_mov_avg_sar($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function cryptobee_momentum($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     * @return int
     */
    public function cryptobee_sma_stoch_rsi($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     *  @return int
     */
    public function cryptobee_sar_sma($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
        $price      = array_pop($data['close']);
     ...
     *  @return int
     */
    public function cryptobee_ema_adx($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     *  @return int
     */
    public function cryptobee_trend_bounce($pair, $data, $return_full=false)
    {
        // custom bbands
     ...
     *  @return int
     */
    public function cryptobee_5th_element($pair, $data, $return_full=false)
    {
        $indicators = new Indicators();
     ...
     *  @return int
     */
    public function cryptobee_powerranger($pair, $data, $return_full=false)
    {
     ...
     *  @return int
     */
    public function cryptobee_famamama($pair, $data, $return_full=false)
    {
