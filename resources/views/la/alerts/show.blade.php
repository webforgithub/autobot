...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $alert->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Alerts", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/alerts/'.$alert->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Alerts", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.alerts.destroy', $alert->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/alerts') }}" data-toggle="tooltip" data-placement="right" title="Back to Alerts"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'configuremacdbot_id')
						@la_display($module, 'user_id')
						@la_display($module, 'alert_type')
						@la_display($module, 'currency_name')
						@la_display($module, 'currency_price')
						@la_display($module, 'alert_time')
					</div>
				</div>
			</div>
		</div>
