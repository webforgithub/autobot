...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $coinigy_setting->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Coinigy_Settings", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/coinigy_settings/'.$coinigy_setting->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Coinigy_Settings", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.coinigy_settings.destroy', $coinigy_setting->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/coinigy_settings') }}" data-toggle="tooltip" data-placement="right" title="Back to Coinigy Settings"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'secrete_key')
						@la_display($module, 'webSocket_api_key')
