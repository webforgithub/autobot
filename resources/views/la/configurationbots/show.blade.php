...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $configurationbot->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("ConfigurationBots", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/configurationbots/'.$configurationbot->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("ConfigurationBots", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.configurationbots.destroy', $configurationbot->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/configurationbots') }}" data-toggle="tooltip" data-placement="right" title="Back to ConfigurationBots"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'alert_mobile_no')
						@la_display($module, 'user_id')
						@la_display($module, 'buy_sale_volume')
						@la_display($module, 'trade_type')
						@la_display($module, 'trade_symbol')
						@la_display($module, 'current_price')
						@la_display($module, 'is_percentage')
						@la_display($module, 'buy_price')
						@la_display($module, 'sell_price')
					</div>
				</div>
			</div>
		</div>
