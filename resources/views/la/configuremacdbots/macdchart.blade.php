...
<div class="box box-success">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-12">
                <div><canvas id="containerOHLC"></canvas></div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
...
@push('scripts')
<script src="/la-assets/js/smoothscroll.js"></script>
...
<script type="text/javascript">
    var fnGenerateChart = function () {
        $.getJSON("{{ url('/get-chart') }}/" + $("#symbol option:selected").val() + "/" + $("#tickerPoint option:selected").val(), function (data) {
            ...
            var config = {
                ...
                options: {
                    ...
                    tooltips: {
                        ...
                        intersect: false,
                        callbacks: {
                            // Use the footer callback to display Advise
            ...
            if(window.myLineMacd && window.myLineMacd !== null){
                window.myLineMacd.destroy();
            }
            var ctxOHLC = document.getElementById('containerOHLC').getContext('2d');
            window.myLineMacd = new Chart(ctxOHLC, configOHLC);
        });
    };
