...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $configuremacdbot->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("ConfigureMACDBots", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/configuremacdbots/'.$configuremacdbot->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("ConfigureMACDBots", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.configuremacdbots.destroy', $configuremacdbot->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/configuremacdbots') }}" data-toggle="tooltip" data-placement="right" title="Back to ConfigureMACDBots"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'alert_email')
						@la_display($module, 'alert_mobile')
						@la_display($module, 'volume')
						@la_display($module, 'totalorder')
						@la_display($module, 'period')
						@la_display($module, 'period_length')
						@la_display($module, 'min_periods')
						@la_display($module, 'ema_short_period')
						@la_display($module, 'ema_long_period')
						@la_display($module, 'signal_period')
						@la_display($module, 'up_trend_threshold')
						@la_display($module, 'down_trend_threshold')
						@la_display($module, 'overbought_periods')
						@la_display($module, 'overbought_rsi')
						@la_display($module, 'use_all_fund')
					</div>
				</div>
			</div>
		</div>
